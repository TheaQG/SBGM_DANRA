...
def plot_return_levels(gev_csv: Path, out_png: Path):
...
def plot_pot(para_csv: Path, out_png: Path):
...
def plot_tails(tails_csv: Path, out_png: Path):
...
def plot_extremes(out_root: str | Path):
    ...
    plot_return_levels(tables / "ext_rxk_gev.csv", figs / "ext_return_levels_rxk.png")
    plot_pot(tables / "ext_pot_gpd.csv", figs / "ext_pot_gpd.png")
    plot_tails(tables / "ext_tails.csv", figs / "ext_tails.png")