#!/bin/bash
#SBATCH --job-name=paper1_EDM_wRainGate_wCosSin_dualLR
#SBATCH --output=logs/slurm_paper1_EDM_wRainGate_wCosSin_dualLR_%x_%j.log
#SBATCH --error=logs/slurm_paper1_EDM_wRainGate_wCosSin_dualLR_%x_%j.err
...
export EVAL_DIR="$ROOT_DIR/evaluate_sbgm/results" 
export LOG_DIR="$ROOT_DIR/sbgm/logs"
...
srun singularity exec $CONTAINER \
    python -m sbgm.cli.main_app --mode full_pipeline --config_path $CONFIG_DIR/paper1_main.yaml --make_plots True
